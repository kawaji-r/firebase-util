 ...
 */
function createTypeSyncer(packageJSONService, packageSource, configService, globber) {
    ...
    function sync(filePath, flags) {
        return __awaiter(this, void 0, void 0, function () {
            var dryRun, _a, file, syncOpts, subPackages, syncedFiles;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), file = _a[0], syncOpts = _a[1];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(__spreadArray([
                            ...
                            ], subPackages.map(function (p) { return syncFile(p, null, syncOpts, dryRun); }), true))];
                    case 3:
                        syncedFiles = _b.sent();
                        return [2 /*return*/, {
     ...
     * @param opts
     */
    function syncFile(filePath, file, opts, dryRun) {
        return __awaiter(this, void 0, void 0, function () {
            var ignoreDeps, ignorePackages, packageFile, _a, allPackages, allPackageNames, potentiallyUntypedPackages, used, devDepsToAdd, devDeps;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        packageFile = _a;
                        allPackages = (0, util_1.flatten)(Object.values(types_1.IDependencySection).map(function (dep) {
                            var section = getDependenciesBySection(packageFile, dep);
                            var ignoredSection = ignoreDeps === null || ignoreDeps === void 0 ? void 0 : ignoreDeps.includes(dep);
                        ...
                        potentiallyUntypedPackages = getPotentiallyUntypedPackages(allPackageNames);
                        used = [];
                        return [4 /*yield*/, Promise.all(potentiallyUntypedPackages.map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            typePackageInfoPromise = fetchPackageInfo(t.typesPackageName);
                                        ...
                                        case 2:
                                            ...
                                            used.push(t);
                                            return [2 /*return*/, (_a = {},
                                                    _a[t.typesPackageName] = semverRangeSpecifier + version,
                                                    _a)];
                                    }
                                });
                    ...
                    case 3:
                        ...
                        devDeps = packageFile.devDependencies;
                        if (!!dryRun) return [3 /*break*/, 5];
                        return [4 /*yield*/, packageJSONService.writePackageFile(filePath, __assign(__assign({}, packageFile), { devDependencies: (0, util_1.orderObject)(__assign(__assign({}, devDepsToAdd), devDeps)) }))];
                    case 4:
                        _b.sent();
                        _b.label = 5;
...
function getPotentiallyUntypedPackages(allPackageNames) {
    ...
    return (0, util_1.filterMap)(allPackageNames, function (p) {
        ...
        var fullTypingsPackage = (0, util_1.typed)(p);
...
function getPackagesFromSection(section, ignoredSection, ignorePackages) {
    return (0, util_1.filterMap)(Object.keys(section), function (name) {
        var isTyping = name.startsWith('@types/');
        // Never ignore `@types` packages.
        if (!isTyping) {
            // If it's not a `@types` package, check whether the section or package is ignored.
            if (ignoredSection || (ignorePackages === null || ignorePackages === void 0 ? void 0 : ignorePackages.includes(name))) {
                return false;
            }
        }
