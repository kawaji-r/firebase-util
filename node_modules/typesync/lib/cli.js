            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    C.success(totals.newTypings === 0
                        ...
                        : (0, chalk_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", " new typings added.\n\n", "\n\n\u2728  Go ahead and run {green npm install} or {green yarn} to install the packages that were added."], ["", " new typings added.\\n\\n", "\\n\\n\u2728  Go ahead and run {green npm install} or {green yarn} to install the packages that were added."])), totals.newTypings.toString(), syncedFilesOutput));
                    return [2 /*return*/];
            }
        });
    });
...
function renderTypeDef(typeDef, isLast) {
    var treeNode = isLast ? '└─' : '├─';
    return (0, chalk_1.default)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["", " ", " {gray @types/}", ""], ["", " ", " {gray @types/}", ""])), treeNode, (0, chalk_1.default)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["{green.bold +}"], ["{green.bold +}"]))), (0, chalk_1.default)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["{bold.blue ", "}"], ["{bold.blue ", "}"])), typeDef.typingsName));
}
/**
...
function renderSyncedFile(file) {
    var badge = file.newTypings.length === 0
        ? (0, chalk_1.default)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["{blue.bold (no new typings added)}"], ["{blue.bold (no new typings added)}"]))) : (0, chalk_1.default)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["{green.bold (", " new typings added)}"], ["{green.bold (", " new typings added)}"])), file.newTypings.length.toString());
    var dirName = path.basename(path.dirname(path.resolve(file.filePath)));
    var title = (0, chalk_1.default)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\uD83D\uDCE6 ", " {gray.italic \u2014 ", "} ", ""], ["\uD83D\uDCE6 ", " {gray.italic \u2014 ", "} ", ""])), file.package.name || dirName, file.filePath, badge);
    var nl = '\n';
    var combined = __spreadArray([], file.newTypings.map(function (t) { return (__assign(__assign({}, t), { action: 'add' })); }), true);
    var rendered = title +
        nl +
        combined
