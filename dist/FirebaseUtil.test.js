...
describe('FirebaseUtil', () => {
    ...
    it('スラッシュが0個の場合', async () => {
        ...
        // 結果確認
        const fetch = (await fb.firestore.readDocument(docRef.path, undefined, true));
    ...
    it('フィールドをマージする', async () => {
        ...
        // 結果確認
        const fetch = (await fb.firestore.readDocument(`test/${nowTime}/mergeField/doc`, undefined, true));
